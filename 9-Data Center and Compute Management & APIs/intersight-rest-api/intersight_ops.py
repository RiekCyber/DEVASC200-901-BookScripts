...
AUTH = IntersightAuth(
    secret_key_filename='/home/e.sebert/Documents/Python/DevNet/Scripts/Data Center and Compute Management/intersight-rest-api/key/SecretKey.txt',
    api_key_id='602e8e407564612d3359029a/602e8e407564612d3359029e/602fdd007564612d3350d159'
    )
...
if __name__ == "__main__":
    ...
    OPERATIONS = [
        ...
        {
            "request_process":True,
            "resource_path":"aaa/AuditRecords",
            "request_method":"GET"
        },
        {
            "request_process":True,
